...
$filename = "OccupancyReport".strtotime("now").'.xls';
...
<table border="1">
			...
			//	echo "select * from  attendance_details $crit group by districtid asc";
				 $ulbdetail=mysqli_query($connection,"select * from  attendance_details  $condata and atten_date='$currentdate' group by districtid asc");
                ...
                <tr>
                    ...
                    <th  colspan="8">District : <?php echo $districtname;?> &nbsp;&nbsp;&nbsp;&nbsp; ULB : <?php echo $ulbname;?>&nbsp;&nbsp;&nbsp;&nbsp; Shelters : <?php echo $totshelter;?></th>
