...
$pagename = "paymentsby_report.php";
...
<body>
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
				...
				<table class="table table-bordered table-striped">
                    ...
                    placeholder='dd-mm-yyyy' value="<?php echo $todate; ?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask /></td>
                       ...
                       <td >
                            ...
                            <button ><a href="paymentsby_report.php"> Clear </a></button>  
						</td>
		...
		<div class="table-responsive">
         <a href="excel_paymentsby_report.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
				<table class="table table-bordered table-striped">
