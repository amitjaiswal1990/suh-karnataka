...
<th>Attendance Date</th>
			...
			echo "select * from attendance_details $crit order by atten_date asc";
				  $shelterdetail=mysqli_query($connection,"select * from attendance_details $crit order by atten_date asc");
