...
$pagename = "auditors_list.php";
$module = "Auditors Details";
$submodule = "Add Auditors Details";
$btn_name = "Save";
$keyvalue = 0;
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Social Audit Assessment Details</h4><a href="auditors_entry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
				...
				<table class="table table-bordered table-striped">
					...
					<tr>
                     ...
                     <th>District</th>
					    ...
					    <?php
						$sn=1;
				 $dist=mysqli_query($connection,"select * from auditors_entry $conuser order by audid desc");
					    ...
					    <tr>
					      ...
					      <td>
					      <?php if($data['imgname']!=''){?>  <img src="uploaded/auditors/<?php echo $data['imgname'];?>"   style=" height:30px; width:30px;" id="imgprvw" /> <?php } ?></td> <td>
					     <?php if($data['inspectionimgname']!=''){?>   <img src="uploaded/auditors/<?php echo $data['inspectionimgname'];?>"  style=" height:30px; width:30px;" id="imgprvw1" /><?php } ?>
					      </td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='auditors_entry.php?audid=<?php echo  $data['audid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['audid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
