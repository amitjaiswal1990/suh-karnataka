...
$pagename = "financial_audit_list.php";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Financial Details</h4><a href="financial_audit.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from financial_audit $conuser order by finid desc");
                        ...
                        <td><?php echo ucfirst(strtolower($districtname));?></td>
                         ...
                         <td><?php echo $cmn->dateformatindia($data['findate']);?></td>
					      <td><?php echo $data['financial_year'];?></td>                          
                              ...
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='financial_audit.php?finid=<?php echo  $data['finid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['finid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
