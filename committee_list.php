...
$pagename = "committee_list.php";
$module = "Staff  Details";
$submodule = "Add Staff Details";
$btn_name = "Save";
$keyvalue = 0;
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Staff Details</h4><a href="staff_entry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
					...
					<tr>
					 <th>Sl.No</th>
                      <th>District</th>
					    ...
					    <?php
				 $sn=1;
										$dist=mysqli_query($connection,"select * from committee_members $conuser  order by memid desc");
					      ...
					      <td><?php echo $data['staff_name'];?></td>                          
                           <td><?php echo $data['address'];?></td>
                             <td><?php echo $data['gender'];?></td>
                              ...
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='committee_entry.php?memid=<?php echo  $data['memid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['memid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
