...
$pagename = "inspection_details_list.php";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Inspection Details</h4><a href="inspection_details_entry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
		 	       ...
		 	       <th>Name Of Inspection Officer</th>
				  <th>Remark</th>
                        <th>Action</th>
					</tr>
					    ...
					    <?php
				  $sno=1;
				  $shelterdetail=mysqli_query($connection,"select * from  inspection_details $conuser order by insid desc");
				  ...
				  <td><?php echo $get_data['inspection_officer']; ?></td>
				  <td><?php echo $get_data['overall_remarks']?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='inspection_details_entry.php?insid=<?php echo  $get_data['insid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $get_data['insid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
...
<script>
	...
	{  //alert(id);   
		...
		if(confirm("Are you sure! You want to delete this record."))
		{
			jQuery.ajax({
			  type: 'POST',
			  url: 'ajax/delete_inspection_master.php',
