...
if ( isset( $_POST[ 'submit' ] ) ) {
	$districtname = test_input( $_POST[ 'districtname' ] );
	echo $statename= $_POST[ 'statename' ];
	//check Duplicate
	$check = check_duplicate( $connection, $tblname, "districtname = '$districtname' and $tblpkey <> '$keyvalue'" );
	if ( $check > 0 ) {
		...
		if ( $keyvalue == 0 ) {
			...
			//insert
			$form_data = array('districtname' => $districtname,'stateid'=>$statename );
...
if ( isset( $_GET[ $tblpkey ] ) ) {
	...
	$districtname = $rowedit[ 'districtname' ];
				...
				<div class="col-md-12">
					<div class="col-md-5">
						...
						<div class="table-responsive">
							<h4 class="mt-0 header-title">District Details</h4>
...
<label for="example-text-input" class="col-sm-6 col-form-label">District Name</label>
										<input class="form-control" type="text" onKeyUP="this.value = this.value.toUpperCase();" value="<?php echo $districtname;?>" id="districtname" name="districtname" required>
									</div>
								</div> 
							...
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tbody>
										...
										<?php
											...
											$sql_get = mysqli_query($connection,"select * from  m_district where 1=1 order by districtid desc");
									...
									?> <tr>
                                                ...
                                                <td><?php echo $row_get['districtname']; ?></td> 
										        <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='?districtid=<?php echo  $row_get['districtid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $row_get['districtid'] ; ?>);' style='cursor:pointer' title="Delete"></a></td>
									</tr>
									<?php } ?>
