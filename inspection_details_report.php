...

{
	...
	$crit .= " where  inspection_date between '$fromdate' and '$todate'";
...
<?php include("inc/body.php");?>
	...
	<div class="wrapper">
      ...
      <a href="excel_inspection_details.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
	  ...
	  <table id="dataTable" class="table display">
		 	  ...
		 	  <tbody>
				...
				//   echo "select * from inspection_details $crit";
                  ...
                  <td><?php echo $get_data['designation'];?></td>
				  <!--<td><?php //echo $get_data['overall_remarks']?></td>-->

		 	      <!--<td><a href="inspection_details.php?id=<?php// echo $get_data['insid']?>" >View Details</a></td>-->
