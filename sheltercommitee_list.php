	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Shelter Committee Details</h4><a href="commitee_details.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
				...
				<table class="table table-bordered table-striped">
                    ...
                    <th>Executive Committee Meeting Date</th>
                      <th>No. Of Members Participated</th>
					    ...
					    <?php
				  $sno=1;
				  $shelterdetail=mysqli_query($connection,"select * from  committee_details_entry $conuser and commi_type='shelter'  order by centryid desc");
		 	    ...
		 	    <td><?php echo ucfirst(strtolower($district));?></td>
				  ...
				  <td><?php echo $get_data['executive_commitee']?></td>
                    <td><?php echo dateformatindia($get_data['date_of_formation_ec'])?></td>
