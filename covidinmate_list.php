...
$pagename = "covidinmate_list.php";
$module = "Covid Inmate Details";
$submodule = "Add Covid Inmate Details";
$btn_name = "Save";
$keyvalue = 0;
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Resident Details</h4><a href="covid_inmatesentry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covid_inmatesentry $conuser order by covidentid desc");
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $data['noofinmate'];?></td>
                            <td><?php echo $data['maleabove18'];?></td>
                            <td><?php echo $data['femaleabove18'];?></td>
                            <td><?php echo $data['childbelow18'];?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='covid_inmatesentry.php?covidentid=<?php echo  $data['covidentid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['covidentid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
