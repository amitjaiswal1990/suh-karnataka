...
<body>
	...
	<div class="wrapper">
      ...
      <a href="excel_staff_attendance_details.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
    ...
    <table class="table table-bordered table-striped">
		 	  ...
		 	  <tbody>
				...
				//echo "select * from staff_attendance_details $crit";
// echo "select * from staff_attendance_details where $crit order by districtid asc";
		 	     ...
		 	     <td> <?php if($profile_photo!=''){?>  <img src="uploaded/staff/<?php echo $profile_photo;?>"   style=" height:30px; width:30px;" id="imgprvw" /> <?php } ?></td> 
                    <td> <?php if($get_data['attendancephoto']!=''){?>  <img src="uploaded/staffattendance/<?php echo $get_data['attendancephoto'];?>"   style=" height:30px; width:30px;" id="imgprvw" /> <?php } ?></td> 
