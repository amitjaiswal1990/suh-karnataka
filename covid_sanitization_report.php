...
if($fromdate!="" && $todate!="")
{
	...
	$crit .= " and  fumigationdate between '$fromdate' and '$todate'";
}
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Sanitization  Details </h4>
		</div>
				...
				<table class="table table-bordered table-striped">
                    ...
                    placeholder='dd-mm-yyyy' value="<?php echo $todate; ?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask /></td>
                       ...
                       <td >
                            ...
                            <button ><a href="covid_sanitization_report.php"> Clear </a></button>  
						</td>
     ...
     <table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covidsanitization $crit");
							while($data=mysqli_fetch_array($dist)){
