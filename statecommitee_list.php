	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">State Committee Details</h4><a href="commitee_details.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
                    ...
                    <th>No. Of Members Participated</th>
					    ...
					    <?php
				  $sno=1;
				  $shelterdetail=mysqli_query($connection,"select * from  committee_details_entry $conuser and commi_type='state'  order by centryid desc");
