...
$pagename = "vacant_list.php";
$module = "Vacant Details";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Vacant Details</h4><a href="vacant_process.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
					...
					<tr>
					 <th>Sl.No</th>
                      <th>District</th>
					    ...
					    <?php
				 $sn=1;
				echo "select * from personal_details $conuser and vacant_status='OUT' order by id desc";
						$dist=mysqli_query($connection,"select * from personal_details $conuser and vacant_status='OUT' order by id desc");
                        ...
                        <td><?php echo ucfirst(strtolower($districtname));?></td>
					      ...
					      <td><?php echo $data['per_name'];?></td>                          
                           <td><?php echo $data['vacant_status'];?></td>
                             <td><?php echo $cmn->dateformatindia($data['vacant_date']);?></td>
                              <td><?php echo $data['vacant_reason'];?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='vacant_process.php?id=<?php echo  $data['id'] ; ?>'></a> /
                                                <!--<a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['id'] ; ?>);'></a>-->
                                                </td>
					    </tr>
					<?php } ?>  
