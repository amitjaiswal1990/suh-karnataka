...
<body>
	...
	<div class="wrapper">
      ...
      <a href="datewiseexcel_attendance_details.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
				...
				//echo "select * from attendance_details $crit";
					  ...
					  $ngo=$cmn->getvalfield($connection,"m_ngo","ngoname","ngoid='$get_data[ngoid]'");
					   $id=$cmn->getvalfield($connection,"personal_details","id","id='$get_data[pid]'");
						...
						$gender=$cmn->getvalfield($connection,"personal_details","gender","id='$id'");
						 $atten_date = $get_data['atten_date'];
		 	    ...
		 	    <td><?php echo ucfirst(strtolower($district));?></td>
				  ...
				  <?php echo $per_name;?></td>
                    ...
                    <td><?php echo dateformatindia($atten_date);?></td>
                             <td>
