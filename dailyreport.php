...
<body>
	...
	<div class="wrapper">
      ...
      <a href="excel_attendance_details.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
    ...
    <table class="table table-bordered table-striped">
		 	  ...
		 	  <tbody>
				...
				//echo "select * from attendance_details $crit";
				  $shelterdetail=mysqli_query($connection,"select * from attendance_details $crit order by districtid asc");
