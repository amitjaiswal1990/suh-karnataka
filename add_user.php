                       ...
                       <option value="">-Select Shelter Name-</option>
                                ...
                                <div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<input  class="form-control" type="text"  value="<?php echo $uname1;?>" id="uname" name="uname">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<input  class="form-control" type="text"  maxlength="10" value="<?php echo $mobile;?>" id="mobile" name="mobile">
									</div>
								</div> 
						...
						<h4 class="mt-0 header-title">User Details</h4>
							...
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tbody>
										...
										<?php	$sql_get = mysqli_query($connection,"select * from add_role ");
											while($row_get = mysqli_fetch_assoc($sql_get))
											{
									$sql = mysqli_query($connection,"select * from  user where role_id='$row_get[role_id]' ");
												$row1 = mysqli_fetch_assoc($sql);
										?>
											<tr><td colspan="5" style="color:#FFB600; font-size: 18px; font-family: bold;"><?php echo $row_get['role_name'];?></td></tr>					
										<?php
												
													$slno=1;
											$sql1 = mysqli_query($connection,"select * from  user where role_id='$row1[role_id]' ");	
