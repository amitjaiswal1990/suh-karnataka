	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">3rd Party Survey Details </h4><a href="thirdpartysurvey.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
                ...
                <th>Shelter Name</th>
                <th> Conductdate</th>
                <th>Thirdparty Ngo</th>
                <th>Thirdparty Amount</th>
                <th>Men</th>
                <th>Women</th>
                <th>Third Gender</th>
                <th>PWP</th>
                      ...
                      <!--  <th>Action</th>-->
					    ...
					    <?php
				  $sno=1;
				//   echo "select * from  thirdpartysurey $conuser order by surveyid desc";
				  $shelterdetail=mysqli_query($connection,"select * from  thirdpartysurey $conuser order by surveyid desc");
