	...
	<div class="card ">
		<div class="card-header ">
			...
			<h4 class="card-title" style="text-align: center;" >
				   ...
				   <span> Occupancy Details:<span style="color: green"> 
					   <?php
					  // $getshel=$cmn->getvalfield($connection,"m_shelter","districtid","shelter_id='$_GET[shelid]'");
					  // echo $getdist=$cmn->getvalfield($connection,"m_district","districtname","districtid='$getshel'");
					   ?>
			...
			<!-- Report Part -->
		 	...
		 	<table class="table table-bordered table-striped">
		 	  ...
		 	  <tbody>
				...
				//echo "select * from attendance_details where atten_date='$fromdate' and ngoid='$ngoid' order by districtid asc";
				  $shelterdetail=mysqli_query($connection,"select * from attendance_details where atten_date='$fromdate' and ngoid='$ngoid' order by districtid asc");
