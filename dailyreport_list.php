...
$pagename = "dailyreport_list.php";
$module = "Personal Details";
$submodule = "Add Personal Details";
$btn_name = "Save";
$keyvalue = 0;
$tblname = "attendance_details";
$tblpkey = "atten_date";
$imgpath='';
$action='';
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Personal Details</h4><a href="personal_details.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
                    ...
                    <th>Gender</th>
					    ...
					    <?php
				  $sno=1;
				  $shelterdetail=mysqli_query($connection,"select * from  attendance_details $conuser order by id desc");
		 	    ...
		 	    <td><?php echo ucfirst(strtolower($district));?></td>
				  ...
				  <td><?php echo $ngo; ?></td>
                    ...
                    <td><?php echo dateformatindia($get_data['atten_date'])?></td>
                              ...
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='dailyreport_entry.php?atten_date=<?php echo  $get_data['atten_date'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $get_data['atten_date'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
