	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Resident Details </h4>
		</div>
				...
				<table class="table table-bordered table-striped">
                    ...
                    placeholder='dd-mm-yyyy' value="<?php echo $todate; ?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask /></td>
                       ...
                       <td >
                            ...
                            <button ><a href="covidinmate_report.php"> Clear </a></button>  
						</td>
		...
		<div class="table-responsive">
         <a href="excel_covidinmatereport.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
    <table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covid_inmatesentry $crit");
							while($data=mysqli_fetch_array($dist)){
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $cmn->dateformatindia($data['fromdate']);?></td> 
