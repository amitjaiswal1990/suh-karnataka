	...
	<div class="card ">
		<div class="card-header ">
			...
			<h4 class="card-title" style="text-align: center;" >
				   ...
				   <span> <?php if($getid==1){ 
				   $con="where conductdate BETWEEN '$firstdate' AND '$currentdate' and (men>0 || women>0 || children>0 || PWP>0) ";
				   echo "Rapid Survey(Shelter)";}
				   else if($getid==2){
					    $con="where conductdate BETWEEN '$firstdate' AND '$currentdate' and (men1>0 || women1>0 || children1>0 || PWP1>0) ";
