...
$pagename = "ulbcontactentry.php";
$module = "Add ULB Contact";
$submodule = "ULB Contact";
$btn_name = "Save";
$keyvalue = 0;
$tblname = "ulb_contact";
$tblpkey = "contactid";
...
if ( isset( $_POST[ 'submit' ] ) ) {
	...
	//check Duplicate
	$check = check_duplicate( $connection, $tblname, "ulbname = '$ulbname' and sheltername = '$sheltername' and contact_person = '$contact_person' and $tblpkey <> '$keyvalue'" );
	if ( $check > 0 ) {
...
if ( isset( $_GET[ $tblpkey ] ) ) {
	...
	$contact_person = $rowedit[ 'contact_person' ];
...
<body>
	...
	<?php } ?>
			...
			<div class="row">
				...
				<div class="col-md-12">
                <a href="uploadulbcontact.php" style="float:right; margin:12px;"  ><button class="btn btn-danger">CLICK FOR BULK UPLOAD</button></a><br>
					<div class="col-md-5">
						
 
						<div class="table-responsive">
							<h3 class="mt-0 header-title">ULB Contact Master</h3>
...
<input type="hidden" name="<?php echo $tblpkey; ?>" id="<?php echo $tblpkey; ?>" value="<?php echo $keyvalue; ?>">
							...
							<br>
										...
										<div class="col-md-7">
						<h4 class="mt-0 header-title">ULB Contact Details</h4>
							...
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tbody>
										...
										<?php
											...
											$sql_get = mysqli_query($connection,"select * from ulb_contact where 1=1 order by contactid desc");
									...
									?> <tr>
                                                ...
                                                <td><?php echo $row_get['sheltername']; ?></td> 
									 			   <td><?php echo $row_get['contact_person']; ?></td> 
                                                      
												
										        <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='?contactid=<?php echo  $row_get['contactid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $row_get['contactid'] ; ?>);' style='cursor:pointer' title="Delete"></a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
