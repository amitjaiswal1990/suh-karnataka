...
$pagename = "medical_camp_list.php";
$module = "Medical Camp Details";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Medical Camp Details</h4><a href="medical_camp_entry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				  ...
				  <th>Remark</th>
					    ...
					    <?php
				  $sno=1;
				  $shelterdetail=mysqli_query($connection,"select * from  medical_camp $conuser order by medid desc");
				 ...
				 <td><?php echo $get_data['no_doctors']?></td>
				  ...
				  <td><?php echo $get_data['remarks']?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='medical_camp_entry.php?medid=<?php echo  $get_data['medid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $get_data['medid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
