...
<div class="container-fluid">
	<div class="card ">
		<div class="card-header ">
			...
			<h4 class="card-title" style="text-align: center;" >
				   ...
				   <span> <?php if($getid==1){ echo "Rapid Survey(Shelter)";}
				   else if($getid==2){ echo "Third Party ULB";}
									...
									<table id="districtWiseSheltersReport" class="example table table-bordered table-condensed table-hover"   >
									  <thead>
											<tr>
                                                ...
                                                <th style="text-align: center;vertical-align: middle;">Conduct Date</th> 
	...
	$occupied=0;
	$curdate=date("Y-m-d");
											$sql_data=mysqli_query($connection,"select * from rapidsurvey");
											while($get_data=mysqli_fetch_array($sql_data)){
												$sno++;
												$districtid=$cmn->getvalfield($connection,"m_district","districtname","districtid='$get_data[districtid]'");
												$ulbid=$cmn->getvalfield($connection,"ulb_master","ulbname","ulbid='$get_data[ulbid]'"); 
											...
											?>
												...
												<tr>
                                                    ...
                                                    <td><?php echo $PWP1 ?></td> 
                                                    <td><?php echo $men1+$women1+$children1+$PWP1 ?></td> 
