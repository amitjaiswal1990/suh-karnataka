	...
	<?php } ?>
			...
			<div class="row">
				...
				<div class="col-md-12">
										...
										<div class="col-md-12">
						<h4 class="mt-0 header-title">ULB Committee Details</h4>
							...
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tbody>
										...
										<?php
											...
											$sql_get = mysqli_query($connection,"select * from committee_details where committee_type='ULB' order by comid desc");
