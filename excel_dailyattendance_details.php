...
$filename = $nowdate."SUHAttendanceReport".'.xlsx';
// Defines the name of the export file "codelution-export.xls"
header("Content-Disposition: attachment; filename=".$filename);

//header('Content-Type: application/xlsx');
    //    header('Content-Disposition: attachment; filename=$nowdateSUHAttendanceReport.xlsx');
?>
...
<th>Attendance Date</th>
		...
		//	echo "select * from attendance_details where atten_date='$current_date'";
				  $shelterdetail=mysqli_query($connection,"select * from attendance_details where atten_date='$atten_date'");
