...
$pagename = "covidactivity_list.php";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Activity Details</h4><a href="covid_activityentry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covidactivityentry $conuser order by activid desc");
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $cmn->dateformatindia($data['activity_date']);?></td>                      
                            <td><?php echo $data['activity_type'];?></td>
                            <td><?php echo $data['nooftakenservices'];?></td>
                            <td><img src="uploaded/covidactivity/<?php echo $data['imgname'];?>" style="width:50px; height:50px;" ></td>
                           
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='covid_activityentry.php?activid=<?php echo  $data['activid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['activid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
