	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Counseling Details Entry</h4>
		</div>
		...
		<div class="card mt-12">
		<div class="card-header">
			<h4 class="card-title">Counselling Details</h4>
		</div>
		<div class="table-responsive">
         <a href="excel_counseling_report.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>&districtid=<?php echo $districtid;?>&ulbid=<?php echo $ulbid;?>&ngoid=<?php echo $ngoid;?>" class="btn btn-info" style="float:right">Export Excel</a>
				...
				<table class="table table-bordered table-striped">
					...
					<tr>
                       ...
                       <td>   <img src="uploaded/counseling/<?php echo $data['imgname'];?>"   style=" height:30px; width:30px;" id="imgprvw" title="Auditor Photo"/> </td> 
