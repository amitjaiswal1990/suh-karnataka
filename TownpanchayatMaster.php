...
$pagename = "TownpanchayatMaster.php";
$module = "Add Townpanchayat";
$submodule = "Townpanchayat Master";
$btn_name = "Save";
$keyvalue = 0;
$tblname = "m_townpanchayat";
$tblpkey = "panchayat_id";
if ( isset( $_GET[ 'panchayat_id' ] ) )
	$keyvalue = $_GET[ 'panchayat_id' ];
else
	$keyvalue = 0;
...
if ( isset( $_POST[ 'submit' ] ) ) {
	...
	//check Duplicate
	$check = check_duplicate( $connection, $tblname, "panchayat = '$panchayat' and $tblpkey <> '$keyvalue'" );
	if ( $check > 0 ) {
				...
				<div class="col-md-12">
					<div class="col-md-5">
						...
						<div class="table-responsive">
							<h3 class="mt-0 header-title">Townpanchayat Master</h3>
							...
							<form action="" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<label for="example-text-input" class="col-sm-12 col-form-label">Town Panchayat</label>

										<input class="form-control" required type="text" onKeyUP="this.value = this.value.toUpperCase();" value="<?php echo $panchayat;?>" id="panchayat" name="panchayat">
									</div>
								</div> 
<input type="hidden" name="<?php echo $tblpkey; ?>" id="<?php echo $tblpkey; ?>" value="<?php echo $keyvalue; ?>">
							...
							<br>
										...
										<div class="col-md-7">
						<h4 class="mt-0 header-title">Townpanchayat Details</h4>
							...
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tbody>
										...
										<?php
											...
											$sql_get = mysqli_query($connection,"select * from m_townpanchayat where 1=1 order by panchayat_id desc");
									...
									?> <tr>
                                                ...
                                                <td><?php echo $row_get['panchayat']; ?></td> 
										        <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='?panchayat_id=<?php echo  $row_get['panchayat_id'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $row_get['panchayat_id'] ; ?>);' style='cursor:pointer' title="Delete"></a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
