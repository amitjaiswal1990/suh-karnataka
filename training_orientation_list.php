...
$pagename = "training_orientation_list.php";
$module = "Auditors Details";
$submodule = "Add Auditors Details";
$btn_name = "Save";
$keyvalue = 0;
$tblname = "training_orientation";
$tblpkey = "trainid";
$imgpath='';
$action='';
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Training & Orientation Details</h4><a href="training_orientation.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
					...
					<tr>
					 <th>Sl.No</th>
                       <th>District</th>
					    ...
					    <?php
						$sn=1;
				$dist=mysqli_query($connection,"select * from training_orientation $conuser order by trainid desc");
                       ...
                       <td>   <img src="uploaded/training/<?php echo $data['imgname'];?>"   style=" height:30px; width:30px;" id="imgprvw" title="Auditor Photo"/> </td> 
					      <td><?php echo $cmn->dateformatindia($data['traindate']);?></td>
                            <td><?php echo $data['level'];?></td>
                             <td><?php echo $data['department'];?></td>
                           <td><?php echo $data['participant'];?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='training_orientation.php?trainid=<?php echo  $data['trainid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['trainid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
