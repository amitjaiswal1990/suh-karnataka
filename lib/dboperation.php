...
function dbInfo()
{
	...
	$db_link =mysqli_connect("$host_name","$db_user","$db_pwd");
	mysqli_select_db("$db_name",$db_link);
}
...
{
	$urlOfOurSite1 = "https://www.fullonwms.com/fullonwms/";
...
{
	//echo "Called";
	//https://bulksms.trinitysolutions.pw/sendsms.jsp?user=miliap&password=Panav@27&sms=hello&mobiles=9770131555&sender=MILAAP
...
function SelectDB($connection,$table_name,$where_clause)
{
	// check for optional where clause
	$whereSQL = '';
	if(!empty($where_clause))
