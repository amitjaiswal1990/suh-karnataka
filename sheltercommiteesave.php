...
error_reporting(0);
$pagename = "monthly_shelter_committee_meeting.php";
$module = "Add Inspection Details";
$submodule = "Inspection Master";
$btn_name = "Save";
$keyvalue = 0;
$tblname = "monthlysheltercommittee_entry";
$tblpkey = "centryid";
...
|| ($_FILES["meetingphoto"]["type"][$f] == "image/pdf")
...
mysqli_query($connection,"update  monthlysheltercommittee_entry set meetingphoto='$docall' where centryid='$lastid'");	

	
	
	$uploaded_filename = uploadImage($imgpath,$pdfmeeting);			
			mysqli_query($connection,"update  monthlysheltercommittee_entry set pdfmeeting='$uploaded_filename' where centryid='$lastid'");	
			...
			if($_FILES['pdfmeeting']['tmp_name']!="")
				{
					...
					//insert new file
					$uploaded_filename = uploadImage($imgpath,$pdfmeeting);	
					//echo "update  monthlysheltercommittee_entry set pdfmeeting='$uploaded_filename' where centryid='$keyvalue'";die;
			mysqli_query($connection,"update  monthlysheltercommittee_entry set pdfmeeting='$uploaded_filename' where centryid='$keyvalue'");
