...
$pagename = "covidstock_list.php";
$module = "Covid Stock Details";
$submodule = "Add Stock Details";
$btn_name = "Save";
$keyvalue = 0;
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Stock Details</h4><a href="covidstockentry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covidstockentry $conuser order by stockid desc");
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $cmn->dateformatindia($data['entrydate']);?></td>                      
                            <td><?php echo $data['noofmasks'];?></td>
                            <td><?php echo $data['noofglove'];?></td>
                            <td><?php echo $data['noofppe'];?></td>
                            <td><?php echo $data['nooffaceshield'];?></td>
            <td><?php echo $data['sanitizer'];?></td>   
             <td><?php echo $data['handwash'];?></td>  
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='covid_stockentry.php?stockid=<?php echo  $data['stockid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['stockid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
