...
$pagename = "covidsanitization_list.php";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Sanitization Details</h4><a href="covid_sanitization_shelter.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covidsanitization $conuser order by sanid desc");
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $cmn->dateformatindia($data['fumigationdate']);?></td>                      
                            <td><?php echo $data['noofsanitiz'];?></td>
                            <td><?php echo $data['remark'];?></td>
                            <td><img src="uploaded/covidsanitization/<?php echo $data['imgname'];?>" style="width:50px; height:50px;" ></td>
                           
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='covid_sanitization_shelter.php?sanid=<?php echo  $data['sanid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['sanid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
