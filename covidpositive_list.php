...
$pagename = "covidpositive_list.php";
	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Covid Positive Details</h4><a href="covid_positiveinmatesentry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from covid_positiveentry $conuser order by positid desc");
					    ...
					    <tr>
					      <td><?php echo $sn++;?></td>
                            ...
                            <td><?php echo $cmn->dateformatindia($data['admissiondate']);?></td>                      
                            <td><?php echo $data['patientname'];?></td>
                            <td><?php echo $data['patientid'];?></td>
                            <td><?php echo $data['age'];?></td>
                            <td><?php echo $data['gender'];?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='covid_positiveinmatesentry.php?positid=<?php echo  $data['positid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['positid'] ; ?>);'></a>
                                                </td>
					    </tr>
					<?php } ?>  
