...
<div class="container-fluid">
	<div class="card ">
		<div class="card-header ">
			...
			<h4 class="card-title" style="text-align: center;" >
				   ...
				   <span> District Wise Report, State Name :<span style="color: green"> Karnataka</span> </span>
	...
	$occupied=0;
	$curdate=date("Y-m-d");
											$sql_data=mysqli_query($connection,"select * from m_district order by districtname");
											while($get_data=mysqli_fetch_array($sql_data)){
												$sno++;
												$d_capacity=$cmn->getvalfield($connection,"m_ngo","max(design_capacity)","districtid='$get_data[districtid]'");
												$c_shelter=$cmn->getvalfield($connection,"m_ngo","count(ngoid)","districtid='$get_data[districtid]'");
											 $occupied1=$cmn->getvalfield($connection,"attendance_details","count(aid)","districtid='$get_data[districtid]' and attendance='Present' and atten_date='$curdate'");
											...
											?>
												...
												<tr>
											    	...
											    	<td style="text-align: right;">
											    		...
											    		<?php echo $c_shelter+0 ?>
											    	</td>
													<td align="right" class="comma  sum"><?php echo $d_capacity+0 ?></td>
											    	<td style="text-align: right;">
											    <?php echo $occupied+$occupied1;; ?>
											    	</td>
