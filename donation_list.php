	...
	<div class="wrapper">
      <?php if($action==1){?> <div class="col-md-12"><h1><span style="color:#F00;">Record Inserted Successfully</span></h1></div>  <?php } ?>
		...
		<div class="card-header">
						<h4 class="card-title">Payment Details</h4><a href="donation_csrentry.php" class="btn btn-success" style="float:right;">Back</a>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped">
					...
					<tr>
					 <th>Sl.No</th>
                      <th>District</th>
						...
						<th>Donation Person / Organisation</th>
                        <th>Amount</th>
                        <th>Date</th>
                        <th>Action</th>
					</tr>
				 ...
				 $sn=1;
						...
						$dist=mysqli_query($connection,"select * from donation_details $conuser order by donid desc");
                        ...
                        <td><?php echo ucfirst(strtolower($districtname));?></td>
					      ...
					      <td><?php echo $data['donperson_org'];?></td>                          
                           <td><?php echo $data['donamount'];?></td>
                             <td><?php echo $cmn->dateformatindia($data['dondate']);?></td>
                              <td><a class="fa fa-edit" style="font-size:20px"  title="Edit" href='donation_csrentry.php?donid=<?php echo  $data['donid'] ; ?>'></a> /
                                                <a class="fa fa-remove" style="font-size:20px;color:red" onclick='funDel(<?php echo  $data['donid'] ; ?>);'></a></td>
					    </tr>
					<?php } ?>  
